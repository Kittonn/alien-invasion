...
class Water:
  def __init__(self) -> None:
    self.water_top = pygame.image.load("./assets/tiles/water.png")
    self.water_center = pygame.image.load("./assets/tiles/center_water.png")
      ...
      for j in range(tile_x_amount):
        ...
        if i == 1:
          sprite = StaticTile(tile_size, x, y, pygame.image.load(
              "./assets/tiles/center_water.png").convert_alpha())
        elif i == 2:
          sprite = StaticTile(tile_size, x, y, pygame.image.load(
              "./assets/tiles/water.png").convert_alpha())
